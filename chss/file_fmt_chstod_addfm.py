...
def process_file(filepath: Path) -> None:
    ...
    new_title = f"{h1_text} | The Treasury of David"
    ...
    description = f"Read the Treasury of David online. A verse-by-verse commentary on the Psalms by Charles Spurgeon. {first_sentence}"
